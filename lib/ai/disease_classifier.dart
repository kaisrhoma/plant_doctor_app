...
/// نتيجة التصنيف
class DiseaseResult {
  final String plant;      // مثال: "Tomato"
  final String label;      // مثال: "Late_blight" (هذا هو كود المرض)
  final double confidence;
  final String title;
  final String description;
  final String? modelUsed;

  // ✅ إضافة "Getters" لتحويل المسميات لما تحتاجه الشاشة
  String get plantCode => plant.toLowerCase().trim(); // تحويل Tomato لـ tomato
  String get diseaseCode => label; // الـ label هو أصلاً الكود التقني للمرض
